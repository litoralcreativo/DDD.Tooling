...
{
	/// <summary>
	/// Code Fix para DDD018: Entity decorado debe heredar de Entity&lt;TId&gt;
	/// Sugiere agregar la herencia de Entity&lt;Guid&gt;
	/// </summary>
	[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EntityInheritanceCodeFixProvider)), Shared]
	public class EntityInheritanceCodeFixProvider : CodeFixProvider
	{
		public sealed override ImmutableArray<string> FixableDiagnosticIds =>
			ImmutableArray.Create("DDD018");
		...
		public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
		{
			...
			context.RegisterCodeFix(
				CodeAction.Create(
					title: "Heredar de Entity<Guid>",
					createChangedDocument: c => AddEntityInheritanceAsync(
						context.Document, classDeclaration, c),
					equivalenceKey: nameof(EntityInheritanceCodeFixProvider)),
				diagnostic);
		}

		private static async Task<Document> AddEntityInheritanceAsync(
